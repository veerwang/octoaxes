...
**最后更新**: 2026-04-16
**当前进度**: octoaxesplus 8 轴 config.h 主体重构完成 — SPI HAL 走 74HC154 + DEPRECATED_PIN 清零 + TTL 8 端口；两工程均编译通过
**下一步**: 8 轴 AxisConfig 扩展（Z2/F1/F2/R/T）+ Axis 实例化（StepAxis/FilterWheel/Objectives 映射）+ MCP23S17 扩展 IO 驱动
