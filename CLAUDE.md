...
**最后更新**: 2026-05-12
**当前进度**: Z 轴编码器启用（`has_encoder=True`）+ XYZ 速度基线归档 + Homing 调试打印清理；响应包保持 24 字节与旧 Squid 兼容
**下一步**: TMC2240 StealthChop 调优 + Cover40 调试代码清理；W 轴 60ms 优化；`STATE_LEAVING_HOME` 静默 reject 修复
