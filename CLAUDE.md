...
**最后更新**: 2026-04-14
**当前进度**: octoaxesplus 硬件配置推进 — 74HC154 片选映射 + CAMERA_TRIGGER 8 路 + Pins 冲突 A1 落地
**下一步**: 8 轴 config.h 主体重构（删 DEPRECATED_PIN + Axis 走 hc154_select + illumination TTL 重映射）+ MCP23S17 扩展 IO 映射
