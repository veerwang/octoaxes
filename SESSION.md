...
|------|--------|--------|
| 细分 | 16 | 8 |
| 最大速度 | 3.828 rev/s | 3.828 rev/s (不变) |
| 最大加速度 | 360 rev/s² | 360 rev/s² (不变) |

**实测 (56 次 12.5mm 移动)**:
- 平均: **64 ms** (基准 144ms, -56%)
- 最快: 48 ms
- 最慢: 73 ms
- 34% 的移动已达到 ≤60ms 目标
...
| 阶段 | 细分 | 速度 | 加速度 | 平均 | 对比基准 |
|------|------|------|--------|------|---------|
| 基准 | 64 | 3.19 rev/s | 300 rev/s² | 144 ms | — |
| 轮次1 | 16 | 3.828 | 360 | 88 ms | -39% |
| 轮次2 | 8 | 3.828 | 360 | 64 ms | -56% |
