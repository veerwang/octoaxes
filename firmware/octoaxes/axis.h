...
protected:
  ...
  // Timeout settings
  // 2026-07-17 5000→15000 (synced with octoaxesplus 2026-07-15 field-tested fix): if a filter
  ...
  // times out (octoaxesplus W2 measured 5.2s ERROR). octoaxes has the same latent boundary,
  // just unexposed when starting near the sensor. For linear axes/objectives this only relaxes
