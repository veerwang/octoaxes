...
/*
  ...
  -----------------------------------------------------------------------------
*/
void tmc4361A_enableLimitSwitch(TMC4361ATypeDef *tmc4361A, uint8_t polarity, uint8_t which, uint8_t flipped, uint8_t isinactive) {
  ...
  switch (which) {
    case LEFT_SW:
      ...
      if (!isinactive)
        ...
        tmc4361A_setBits(tmc4361A, TMC4361A_REFERENCE_CONF, TMC4361A_LATCH_X_ON_INACTIVE_L_MASK);
      break;
    case RGHT_SW:
      // Set whether they are low active (set bit to 0) or high active (1)
      ...
      if (!isinactive)
        ...
        tmc4361A_setBits(tmc4361A, TMC4361A_REFERENCE_CONF, TMC4361A_LATCH_X_ON_INACTIVE_R_MASK);
      break;
  }
  return;
}
...
void tmc4361A_enableHomingLimit(TMC4361ATypeDef *tmc4361A, uint8_t polarity, uint8_t which, uint16_t safety_margin) {
  ...
  tmc4361A_writeInt(tmc4361A, TMC4361A_HOME_SAFETY_MARGIN, safety_margin);
  return;
}
