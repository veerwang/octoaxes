...
bool initializeSystem() {
  ...
  // 初始化时钟
  initializeClock(Pins::TMC4361_STANDARD_CLK, SystemConfig::TMC4361_CLOCK_FREQUENCY);
  initializeClock(Pins::TMC4361_EXPAND_CLK, SystemConfig::TMC4361_CLOCK_FREQUENCY);
  ...
  if (!axisManager.addAxis(xAxis) || !axisManager.addAxis(yAxis) || !axisManager.addAxis(zAxis) || !axisManager.addAxis(wAxis)) {
  //if (!axisManager.addAxis(zAxis)|| !axisManager.addAxis(expand1Axis) || !axisManager.addAxis(expand3Axis) || !axisManager.addAxis(expand4Axis) || !axisManager.addAxis(wAxis)) {
