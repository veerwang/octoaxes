...
namespace AxisConstDefinition {
		...
		const float MAX_VELOCITY_FILTERWHEEL_mm = 3.19 * SCREW_PITCH_FILTERWHEEL_MM;
		...
		const float MAX_ACCELERATION_FILTERWHEEL_mm = 300 * SCREW_PITCH_FILTERWHEEL_MM;
		...
		const float FILTERWHEEL_MOTOR_RMS_CURRENT_mA = 1900;
